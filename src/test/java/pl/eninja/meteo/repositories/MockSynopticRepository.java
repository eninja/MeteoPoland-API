...
public class MockSynopticRepository {
    ...
    public List<SynopticMeasurements> synopticMeasurements1() {
        ...
        SynopticMeasurements synopticMeasurements = new SynopticMeasurements.SynopticMeasurementsBuilder().id(1L)
                                                                                                          .foreignId(100)
                                                                                                          .city("Warszawa")
                                                                                                          .saveDate(date)
                                                                                                          .temperature(6)
        ...
        SynopticMeasurements synopticMeasurements1 = new SynopticMeasurements.SynopticMeasurementsBuilder().id(2L)
                                                                                                           .foreignId(
                                                                                                                   110)
                                                                                                           .city("Warszawa")
                                                                                                           .saveDate(
        ...
        SynopticMeasurements synopticMeasurements2 = new SynopticMeasurements.SynopticMeasurementsBuilder().id(3L)
                                                                                                           .foreignId(
                                                                                                                   130)
                                                                                                           .city("Warszawa")
                                                                                                           .saveDate(
    ...
    public List<SynopticMeasurements> synopticMeasurements2() {
        ...
        SynopticMeasurements synopticMeasurements = new SynopticMeasurements.SynopticMeasurementsBuilder().id(11L)
                                                                                                          .foreignId(111)
                                                                                                          .city("Szczecien1")
                                                                                                          .saveDate(date)
                                                                                                          .temperature(
        ...
        SynopticMeasurements synopticMeasurements1 = new SynopticMeasurements.SynopticMeasurementsBuilder().id(12L)
                                                                                                           .foreignId(
                                                                                                                   112)
                                                                                                           .city("Szczecin2")
                                                                                                           .saveDate(
